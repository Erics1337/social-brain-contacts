...
const slides: Slide[] = [
  {
    ...
    text: "Your solution for expanding and refining your communications to the complex web of social relations in your life.",
    backgroundColor: "#59b2ab",
    graphic: SlideGraphics.welcome, // Update path to actual graphic file
  },
  {
    key: "slide2",
    title: "This app uses social science to make your life better.",
    text: "Use scientific research in social brain theory to make social media work with your biology, not against it.",
  ...
  },
  {
    ...
    text: "Let's take a look at how to navigate the app and get started improving your digital social life.",
    backgroundColor: "#824caf",
    graphic: SlideGraphics.letsgo, // Update path to actual graphic file
  },
];

const AppIntroSliderScreen = ({ onDone }: { onDone: () => void }) => {
  const renderItem = ({ item }: { item: Slide }) => (
    ...
    >
      ...
      <Text className="text-white text-base text-center px-2">{item.text}</Text>
    </View>
  );
  ...
  const renderDoneButton = () => (
    <View className="bg-primary rounded-full px-4 py-2">
      <Text className="text-white font-bold" onPress={handleDoneButton}>
        Done
      </Text>
    </View>
  );
