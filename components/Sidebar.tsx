...
const Sidebar: React.FC = () => {
	...
	return (
		<>
			...
			>
				<TouchableOpacity onPress={toggleSidebar} className='mb-5'>
					<Text style={{ fontSize: 24 }}>X</Text>
				</TouchableOpacity>
				<View style={{ flexDirection: "column" }}>
					<TouchableOpacity
						className="bg-primary py-2 px-4 rounded mb-3"
						onPress={() => {
					...
					>
						<Text className="text-primary text-center text-xl">Account</Text>
					</TouchableOpacity>
					<TouchableOpacity
						className='mb-5'
			...
			>
				...
				<View style={{ flexDirection: "column" }}>
					...
					>
						<Text className="text-center text-xl text-red">Delete Account</Text>
					</TouchableOpacity>
					<TouchableOpacity
						style={{ marginBottom: 10 }}
						onPress={() => handleLogout()}
					>
						<Text className="text-center text-xl text-blue-300">Sign Out</Text>
					</TouchableOpacity>
				</View>
			</Animated.View>
			...
			>
				...
				<View className="flex-col">
					...
					<TouchableOpacity
						onPress={() =>
							Linking.openURL("https://www.socialbraincontacts.com")
						}
					>
